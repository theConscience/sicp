...
; 65536  ; -> то есть (A 2 4) это (2 ^ (2 ^ (2 ^ 2)))
;          a например (A 2 5) это (2 ^ (2 ^ (2 ^ (2 ^ 2))))
;         и так далее (A 2 6) это (2 ^ (2 ^ (2 ^ (2 ^ (2 ^ 2)))))
...
(define (h n) (A 2 n))  ; (2 ^ (2 ^ 2)) ^ повторить эту операцию рекурсивно n-1
; раз. Примеры:
; (A 2 3) ->  2 ^ (2 ^ 2)
; (A 2 4) ->  2 ^ (2 ^ (2 ^ 2)
; (A 2 5) ->  2 ^ (2 ^ (2 ^ (2 ^ 2)))
